...
if (!isset($_SESSION['club_login'])) {
    header("location: testconnectuserid.php");

$user_id = $_SESSION['club_login'];

$stmt = $auth_user->runQuery("SELECT * FROM masterlogin WHERE id=:id, username=:username, email=:email");
...
<label class="h5">welcome : <?php print($_SESSION['club_login'] = $_SESSION['username']); ?></label>
<?php } ?>     
<hr>
